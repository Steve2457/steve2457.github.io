    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-the-super-arxiv-extension-surpassed-600-users-one-month-after-launch-thank-you-for-the-support",
          title: '🚀 The Super arXiv extension surpassed 600 users one month after launch. Thank...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%75%6E%61%6E%68%75%30%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Steve2457", "_blank");
        },
      },{
        id: 'social-scholar',
